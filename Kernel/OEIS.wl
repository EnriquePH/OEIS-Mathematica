...
(* :History:
    ...
    V. 3.2 21 Jul 2026. Fixed OEISbFile so a locally predefined ID[n_]
      is used to compute terms up to VMax, instead of truncating to
      whatever data OEIS already has published.
    V. 4.0 21 Jul 2026. Converted to a proper Wolfram Language paclet
      ...
      loader for `Get["OEIS.m"]` users. See CHANGELOG.md for details.
*)
(* :Keywords:
